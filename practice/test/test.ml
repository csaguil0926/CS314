...
let m10 = App(App(Lam("x", Var"x"),Lam("x",App(Var "y", Var "x"))), Lam("z", Var"z"));;
let m11 = App (Lam ("x", App (Var "y", Var "x")), Lam ("z", Var "z"));;
let m9 = Lam ("x", App (Var "y", Var "x"));;
let m12 = App(Lam ("x", Var "x"), Lam ("x", App (Var "y", Var "x")));;
let m14=App (Var "y", Lam ("z", Var "z"));;
let m15 = (Lam("y", App( App(Var "b", Var "y"), Var "z")));;
...
(*
(* TESTS *)
print_lambda m15; print_newline ();;
